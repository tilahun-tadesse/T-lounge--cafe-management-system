...
function password_button()
{
    ...
    else if(password=="")
    {
      ...
      {
           document.getElementById("passwordinput").style.borderColor='red';
          document.getElementById("numberpassword").style.display='block';
...
function confirm_click()
{
     var password= document.getElementById("passwordinput").value;
      ...
      if(confirm.length>8)
      {
           document.getElementById("cinfirm").style.borderColor='red';
      ...
      {
           document.getElementById("cinfirm").style.borderColor='red';
          document.getElementById("numberconfirm").style.display='block';
      }
      else
      { document.getElementById("cinfirmp").style.borderColor='green';
...
function phone_click()
{
    ...
    if(phone.length>10)
      ...
      else if(!/^[0-9]$/.test(phone))
      {
          ...
          document.getElementById("numberphone").style.display='block';
      }
      else if(phone=="")
      {
            document.getElementById("mobile").style.borderColor='red';
