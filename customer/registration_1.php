...
<html>
  <head>
    ...
    <script src="reserver/validat_1.js" type="text/javascript"></script>
              ...
              <tr style="margin-top: 20px;">    
                ...
                <tr style="margin-left: 20px;">    
                 ...
                 <tr>    
                    ...
                    <td>   
                        <div class="user_name">
                            <input id="user_name" type="text"  size="50" name="user" placeholder="user name" required="" onclick="email_click();"style="margin-top:20px; margin-left: 20px; width: 200px;" ><i style="display: none; color: green; float: right" id="checku" class="fa fa-check "></i>
                            <i id="username">maximum length 10</i>
                        </div>
                    </td>     
                </tr> 
                <tr>    
                    ...
                    <td>  
                        <div class="password">
                            ...
                            <input id="passwordinput" type="password"  size="50" name="password" placeholder="password" required="" onclick="user_click();"style="margin-top:20px; margin-left: 20px; height: 15px; width: 200px;"><i style="display: none; color: green; float: right" id="checkp" class="fa fa-check "></i>
                            <i id="password">maximum length 8</i>  
                            <i id="numberpasword">only number</i>
                            <div>
                    </td>    
                </tr> 
                ...
                <tr>    
                    ...
                    <td>  
                        <div class="confirm">
                            <input id="confirm" type="password" size="50" name="confirm" placeholder="user name" required="" onclick="password_button();"style="margin-top:20px; margin-left: 20px; width: 200px; height: 15px;"><i style="display: none; color: green; float: right" id="checkc" class="fa fa-check "></i>
                            <i id="confirmpassword">not mach</i>  
                             <i id="numberconfirm">only number</i>
                            <div>
                    </td>    
                </tr>
                <tr>    
                    ...
                    <td>  
                        <div class="mobile">
                            <input id="mobile" type="number" name="phone" value=""required="" placeholder="9-333-333-33" onclick="confirm_button();" style="margin-top:20px; margin-left: 20px; width: 200px;"/> <i style="display: none; color: green; float: right" id="checkm" class="fa fa-check "></i>
                ...
                <tr>    
                    ...
                    <td>   
                        <div class="gender">
                            <input type="radio" name="gender" value="male" checked="on" style="margin-top: 20px; margin-left: 20px;" >Male    
