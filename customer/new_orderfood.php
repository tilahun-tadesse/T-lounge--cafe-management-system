...
echo $submitname=($sumArray['name']);
echo $submitprice=($sumArray['price']);
echo $submitquantity=($sumArray['quantity']);
...
$submitquantity=($sumArray['quantity']);
    ...
    $insert= "INSERT INTO `userorder`(`id`, `fullname`, `email`, `sex`, `phone`, `building`, 
            `orderstart`, `lasttime`, `foodname`, `totalprice`, `quantity`) VALUES ('[]',
                    '[$fullname]','$email','$gender','$phone',
            '$building','','$timelimit','$submitname','$submitprice','$submitquantity')";
